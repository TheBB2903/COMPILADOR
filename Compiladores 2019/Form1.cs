    ...
    public partial class Form1 : Form {
        ...
        private void button1_Click_1(object sender, EventArgs e){
            ...
            for (int x = 0; x < dataGridView1.RowCount; x++){
                ...
                if (dataGridView1.Rows[x].Cells[0].Value.ToString().Equals("ERROR")){
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if(contador_error_compilar==0){
                ...
                using (StreamWriter writer = new StreamWriter("C:\\Users\\LUIS\\Desktop\\3-21\\Proyecto Final DOOES\\DOOES en C++.cpp", false))
                ...
                //Mostrando codigo de C++
                string texto = string.Empty;
                string path = "C:\\Users\\LUIS\\Desktop\\3-21\\Proyecto Final DOOES\\DOOES en C++.cpp";
        ...
        public void estruc_ver(){
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "ver")){
                ...
                recorrido_sum += 1;
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$") || Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$")){
